...
public class ModBlocks
{
    ...
    public static void init()
    {
        ...
        wood_chest = register(new CursedChestBlock(FabricBlockSettings.copy(Blocks.OAK_PLANKS).build()), "wood_chest", 3,
                new TranslatableComponent("container.cursedchests.wood_chest"), new Identifier("minecraft", "textures/entity/chest/normal.png"),
        ...
        iron_chest = register(new CursedChestBlock(FabricBlockSettings.copy(Blocks.IRON_BLOCK).build()), "iron_chest", 6,
                new TranslatableComponent("container.cursedchests.iron_chest"), new Identifier("cursedchests", "textures/entity/iron_chest/single.png"),
        ...
        gold_chest = register(new CursedChestBlock(FabricBlockSettings.copy(Blocks.GOLD_BLOCK).build()), "gold_chest", 9,
                new TranslatableComponent("container.cursedchests.gold_chest"), new Identifier("cursedchests", "textures/entity/gold_chest/single.png"),
        ...
        diamond_chest = register(new CursedChestBlock(FabricBlockSettings.copy(Blocks.DIAMOND_BLOCK).build()), "diamond_chest", 12,
                new TranslatableComponent("container.cursedchests.diamond_chest"), new Identifier("cursedchests", "textures/entity/diamond_chest/single.png"),
        ...
        obsidian_chest = register(new CursedChestBlock(FabricBlockSettings.copy(Blocks.OBSIDIAN).build()), "obsidian_chest", 12,
                new TranslatableComponent("container.cursedchests.obsidian_chest"), new Identifier("cursedchests", "textures/entity/obsidian_chest/single.png"),
    ...
    private static CursedChestBlock register(CursedChestBlock block, String name, int rows, TranslatableComponent containerName, Identifier singleTexture,
