package ninjaphenix.expandedstorage.api.client.gui.components;
...
public class SearchEditBox extends TextFieldWidget
{
    private boolean ignoreNextChar;

    public SearchEditBox(TextRenderer textRenderer, int x, int y, int width, int height, String message)
    {
