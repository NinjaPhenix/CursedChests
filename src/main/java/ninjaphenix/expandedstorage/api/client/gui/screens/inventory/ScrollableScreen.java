package ninjaphenix.expandedstorage.api.client.gui.screens.inventory;
...
import ninjaphenix.expandedstorage.api.client.gui.components.SearchEditBox;
import ninjaphenix.expandedstorage.api.world.inventory.ScrollableMenu;

@Environment(EnvType.CLIENT)
public class ScrollableScreen extends AbstractContainerScreen<ScrollableMenu> implements ContainerProvider<ScrollableMenu>
{
    ...
    public ScrollableScreen(ScrollableMenu container, PlayerInventory playerInventory, Text containerTitle)
    {
    ...
    public static ScrollableScreen createScreen(ScrollableMenu container)
    {
    ...
    {
        super.init();
        searchBox = addButton(new SearchEditBox(font, left + 82, top + 127, 80, 8, ""));
