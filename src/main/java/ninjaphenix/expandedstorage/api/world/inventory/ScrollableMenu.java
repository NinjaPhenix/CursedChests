package ninjaphenix.expandedstorage.api.world.inventory;
...
public class ScrollableMenu extends Container
{
    ...
    public ScrollableMenu(int syncId, PlayerInventory playerInventory, SidedInventory inventory, Text containerName)
    {
        super(null, syncId);
