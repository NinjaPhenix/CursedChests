package ninjaphenix.expandedstorage.api.world;
...
public class SidedCompoundContainer implements SidedInventory
{
    private final SidedInventory first;
    private final SidedInventory second;

    public SidedCompoundContainer(SidedInventory firstInventory, SidedInventory secondInventory)
    {
