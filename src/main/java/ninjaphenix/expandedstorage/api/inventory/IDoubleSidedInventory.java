...
public class IDoubleSidedInventory implements ISidedInventory
{
	...
	@Override
	public boolean isUsableByPlayer(PlayerEntity player) { return first.isUsableByPlayer(player) && second.isUsableByPlayer(player); }
	...
	public boolean isPart(ISidedInventory inventory) { return first == inventory || second == inventory; }
